...
const overflowExampleTemplate = (selector) => {
  return new Example({
    ...
    markupForRendering: `<div class="pa4"><div class="${selector} w-6 h-5 ba b--gray-dark bg-gray-lightest black">
...
const truncateExampleTemplate = (selector) => {
  return new Example({
    ...
    markupForRendering: `<div class="pa4"><div class="${selector} overflow-hidden ws-nowrap w-6 ba b--gray-dark bg-gray-lightest black">
    The spice must flow!
</div></div>`,
  })
}
